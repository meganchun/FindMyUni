...
public class FontClass extends JFrame {
	...
	public static Font medium16, medium20, medium25, medium50;
	public static Font semibold25, semibold30, semibold50;
	...
	public FontClass() {
		...
		try {
		    ...
		    medium16 = Font.createFont(Font.TRUETYPE_FONT, new File("Fonts/DMSansMedium.ttf")).deriveFont(20f);
