...
public class GeneralSearchFrame extends JFrame{
	...
	private void addTopPanel() {
		...
		sortAndFilterObjects.setLayout(null);
			...
			sortOptions.setFont(FontClassJeff.medium25);
			filterButton.setFont(FontClassJeff.medium25);
		...
		searchObjects.setLayout(null);
			...
			searchField.setFont(FontClassJeff.medium25);
	...
	public FontClassJeff getFonts() {
		return fonts;
	}

	public void setFonts(FontClassJeff fonts) {
		this.fonts = fonts;
	}
	...
	public FileReader getImportedPrograms() {
		return importedPrograms;
	}

	public void setImportedPrograms(FileReader importedPrograms) {
